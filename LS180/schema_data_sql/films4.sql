...
VALUES 
    ...
    ('Bourne Idenity', 2002, 'espionage', 'Doug Liman', 118);

UPDATE films SET title = 'Wayne''s World' WHERE director = 'Penelope Spheeris';
...
-- Insert the data
INSERT INTO people_2 (id, name) VALUES
(1, 'Abedi'),
(2, 'Allyssa'),
(3, 'amy'),
(4, 'ben'),
...
-- Create the users table with admin as a BOOLEAN
CREATE TABLE users (
    id SERIAL PRIMARY KEY,
    name VARCHAR(50) NOT NULL,
    email VARCHAR(100) NOT NULL,
    admin BOOLEAN, -- Boolean for true/false
    last_login TIMESTAMP
);

-- Insert the data
INSERT INTO users (id, name, email, admin, last_login) VALUES
...
(4, 'Arron', 'arronrose@example.com', FALSE, '2018-01-29 21:37:46'),

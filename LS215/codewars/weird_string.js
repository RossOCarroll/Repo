...
word upper cased, and all odd indexed characters in each word lower cased. The indexing just explained is 
zero based, so the zero-ith index is even, therefore that character should be upper cased and you need to 
...
Input
  - a string 
Output
  - The string but the even index letters capitalized and the 

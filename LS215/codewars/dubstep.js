...
words), and then the boy glues together all the words, including "WUB"
...
Examples
song_
decoder("WUBWEWUBAREWUBWUBTHEWUBCHAMPIONSWUBMYWUBFRIENDWUB") => WE ARE THE
CHAMPIONS MY FRIEND
=end
p song_
decoder("AWUBBWUBC") == "A B C"
p song_
decoder("AWUBWUBWUBBWUBWUBWUBC") == "A

Input:
  - A string of letters
Output:
  - A string with word 'WUB' removed

Requirements:
  - Input will be a non empty string
  - The string will consist of less then 200 characters
  - The letters wull be all upppercase

data structure:
  - Split the string by the 'WUB' into an array
...
function decoder(string) {
  return string.split('WUB').filter(word => word).join(' ');
}



console.log(decoder("WUBWEWUBAREWUBWUBTHEWUBCHAMPIONSWUBMYWUBFRIENDWUB")) //=> WE ARE THE CHAMPIONS MY FRIEND

console.log(decoder("AWUBBWUBC"))// == "A B C"

console.log(decoder("AWUBWUBWUBBWUBWUBWUBC"))// == "A B C"

console.log(decoder("WUBAWUBBWUBCWUB"))// == "A B C"
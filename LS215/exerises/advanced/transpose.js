...
Output:
  - A transposed array where the rows and the columns are swapped

Requirements:
  - In a 3 x 3 matrix we can access the rows ie matrix[n] and the elements in that row matrix[n][y]
  - Return a new 2d array with the the rows and the columns swapped

...
/*
Algorithm:
  - Bas case: if node is null return
  - Base Case: if node value equals target then return true
  - Re cursive case if target is less then node value
    - Traves the left of the tree
  - else

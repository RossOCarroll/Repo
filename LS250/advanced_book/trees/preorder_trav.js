...
/*
Algorithm:
  - create a empty array to store the values
  - func traverse takes node
    - Base case: if node is null return
    - push the node value to emoty array
    - if left value is not null traverse left
    - else if right value is not null traverse right
  - return result array

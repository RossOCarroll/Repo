...
/*
Algorithm:
  - Create a result array set to an emoty array
  - Create a que to the root val
  - loop while queue length > 0
    - declare a currentNode thats at the front of the queue
    - push node.val to result
    - if node.left exisits add to the queue
    - if node.right exisits add to the queue
  - return result

...
# output:
#   - integer finding the duplicate in the unordered list.

# Explicit requirments:
#   - There is only one pair of duplicates
...
# Algorithm:
#   - set a current element
#   - iterate through input array
#     - Check if current element is equal to iteration element
#     - is true select element and return.


def find_dup(array)
  duplicate = array.find_all {|num| array.count(num) > 1}
  duplicate[0]
end

...
Output:
  -The integer that occures an odd number of times in the array

Rules:
  Explicit:
    -There will always be one odd number in the array
...
Algorithm:
  -Iterage over the input array
    -For each number 
      -Count the number of time the current number occures in the array

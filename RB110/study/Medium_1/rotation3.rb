...
rotate again to 321759. Keep the first 3 digits fixed in place and rotate again to get 321597. Finally, 
keep the first 4 digits fixed in place and rotate the final 2 digits to get 321579. The resulting number is 
...
Ouput:
  -The maximun roation of that number
...
Algorithm
  ...
  -Get the size of the string that will determine the rotations
  -Set a rotaton vatiable to 0
  -While rotation > the size of the input string
    -resign the input string to return of the rotate mentod

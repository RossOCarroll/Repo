...
Ouput:
  -True or false depending on if the two arrays elements are multiples in both arrays

Explicit
  -If an empty array is passed return false
...
Algorithm
  ...
  -Iterate over array 1
    -check if current number squared appears in array 2
      -if true append to result array
      -False otherwise
  -Return true if all of the result array is true
    -False other wise
...
def comp(array1, array2)
  ...
  array1.each do |num|
    squared = num * num
    result_array << array2.any?(squared)
  end
